        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?= $kategori_blog; ?></td>
              <td align="center">
                <a href="index.php?include=edit-kategori-blog&data=<?php echo $id_kategori_blog; ?>" class="btn btn-xs btn-info">
                  <i class="fas fa-edit"></i> Edit</a>
                <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_blog; ?>?')) window.location.href='index.php?include=kategori-blog&aksi=hapus&data=<?php echo $id_kategori_blog; ?>¬if=hapusberhasil'" class="btn btn-xs btn-warning">

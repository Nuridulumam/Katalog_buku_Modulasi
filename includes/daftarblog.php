    ...
    <section id="blog-list">
                    ...
                    <?php
                            ...
                            if ($jum_halaman == 0) {
                                ...
                                if ($halaman > 1 && $halaman < $jum_halaman) {
                                    echo " <a class='btn btn-outline-primary' href='index.php?include=daftar-blog&data=$id_kategori_blog&halaman=$setelah' >Older</a>";
                                    echo "<a class='btn btn-outline-primary'href='index.php?include=daftar-blog&data=$id_kategori_blog&halaman=$sebelum' >Newer</a>";
                                } else if ($halaman != 1) {
                                    echo " <a class='btn btn-outline-secondary disabled' href='index.php?include=daftar-blog&data=$id_kategori_blog&halaman=$setelah' aria-disabled='true' >Older</a>";
                                    echo "<a class='btn btn-outline-primary' href='index.php?include=daftar-blog&data=$id_kategori_blog&halaman=$sebelum' tabindex='-1'>Newer</a>";
                                } else if ($halaman != $jum_halaman) {
                                    echo " <a class='btn btn-outline-primary' href='index.php?include=daftar-blog&data=$id_kategori_blog&halaman=$setelah' >Older</a>";
                                    echo "<a class='btn btn-outline-secondary disabled' href='index.php?include=daftar-blog&data=$id_kategori_blog&halaman=$sebelum' tabindex='-1' aria-disabled='true'>Newer</a>";
                                }
                            } ?>
                </nav>
        <?php }
        ...
        ?>
            ...
            <aside class="col-md-3 blog-sidebar">
                ...
                <!-- list blog blog -->
                <h5 class="font-italic bg-info text-white rounded p-2">blogs</h5>
                <ol class="list-group list-group-flush mb-5">
                    ...
                    while ($data_t = mysqli_fetch_row($query_t)) {
                        $id_blog = $data_t[0];
                        $Tanggal = $data_t[1]; ?>
                        <li class="list-group-item"><a href="index.php?include=daftar-blog&data=<?php echo $Tanggal; ?>"> <?php echo $Tanggal; ?></a></li>
                    <?php } ?>
                </ol>
            </aside>

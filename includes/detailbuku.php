    ...
    <div class="row">
      <div class="col-md-9 katalog-detail">
        <div class="table-responsive">
          <table class="shadow-sm p-2 rounded table table-bordered">
            <?php
            if (isset($_GET['data'])) {
              $id_buku = $_GET['data'];
      ...
      <div class="col-md-3">
        <div class="pb-4">
          <h5 class="font-italic bg-info text-white rounded p-2">Buku Terkait</h5>
          <ol class="list-group list-group-flush mb-0">
            ...
            ?>
              <li class="list-group-item"><a href="index.php?include=detail-buku&data=<?php echo $id_buku_terkait; ?>">

        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?= $kategori_buku; ?></td>
              <td align="center">
                <a href="index.php?include=edit-kategori-buku&data=<?php echo $id_kategori_buku; ?>" class="btn btn-xs btn-info">
                  <i class="fas fa-edit"></i> Edit</a>
                <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_buku; ?>?')) window.location.href='index.php?include=kategori-buku&aksi=hapus&data=<?php echo $id_kategori_buku; ?>¬if=hapusberhasil'" class="btn btn-xs btn-warning">

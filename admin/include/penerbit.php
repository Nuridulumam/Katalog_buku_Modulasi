        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?= $alamat ?></td>
              <td align="center">
                <a href="index.php?include=edit-penerbit&data=<?php echo $id_penerbit; ?>" class="btn btn-xs btn-info" title="Edit"><i class="fas fa-edit"></i> Edit</a>
                <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $penerbit; ?>?')) window.location.href = 'index.php?include=penerbit&aksi=hapus&data=<?php echo $id_penerbit; ?>¬if=hapusberhasil'" class="btn btn-xs btn-warning" class="btn btn-xs btn-warning"><i class="fas fa-trash" title="Hapus"></i> Hapus</a>
              </td>
            </tr>
          <?php $posisi++;
          } ?>
